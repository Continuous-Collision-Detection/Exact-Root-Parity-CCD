...
int deltaVolume_exact(double px, double py, double pz, double dx, double dy, double dz, double qx, double qy, double qz, double rx, double ry, double rz, double sx, double sy, double sz)
{
	...
	double qx_px1[3];
	o.two_One_Diff(qx_px, dx, qx_px1);
	double qy_py1[3];
	o.two_One_Diff(qy_py, dy, qy_py1);
	double rx_px1[3];
	o.two_One_Diff(rx_px, dx, rx_px1);
	double ry_py1[3];
	o.two_One_Diff(ry_py, dy, ry_py1);
	double rz_pz1[3];
	o.two_One_Diff(rz_pz, dz, rz_pz1);
	double qz_pz1[3];
	o.two_One_Diff(qz_pz, dz, qz_pz1);
	double sx_px1[3];
	o.two_One_Diff(sx_px, dx, sx_px1);
	double sy_py1[3];
	o.two_One_Diff(sy_py, dy, sy_py1);
	double sz_pz1[3];
	o.two_One_Diff(sz_pz, dz, sz_pz1);
	double tmp_a1[18];
