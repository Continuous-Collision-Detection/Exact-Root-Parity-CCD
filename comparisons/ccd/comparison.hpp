...
namespace comparison {
    ...
    /// Methods of continous collision detection.
    enum CCDMethod {
     ...
     *
     * @param[in]  edge0_vertex0_start  Start position of the first edge's
     *                                  first vertex.
     * @param[in]  edge0_vertex1_start  Start position of the first edge's
     *                                  second vertex.
     * @param[in]  edge1_vertex0_start  Start position of the second edge's
     *                                  first vertex.
     * @param[in]  edge1_vertex1_start  Start position of the second edge's
     *                                  second vertex.
     * @param[in]  edge0_vertex0_end    End position of the first edge's
     *                                  first vertex.
     * @param[in]  edge0_vertex1_end    End position of the first edge's
     *                                  second vertex.
     * @param[in]  edge1_vertex0_end    End position of the second edge's
     *                                  first vertex.
     * @param[in]  edge1_vertex1_end    End position of the second edge's
     *                                  second vertex.
     ...
     * @param[in]  face_vertex0_start  Start position of the first vertex of
     *                                 the face.
     * @param[in]  face_vertex1_start  Start position of the second vertex of
     *                                 the face.
     * @param[in]  face_vertex2_start  Start position of the third vertex of
     *                                 the face.
     * @param[in]  vertex_end          End position of the vertex.
     * @param[in]  face_vertex0_end    End position of the first vertex of
     *                                 the face.
     * @param[in]  face_vertex1_end    End position of the second vertex of
     *                                 the face.
     * @param[in]  face_vertex2_end    End position of the third vertex of
     *                                 the face.
     * @param[in]  method              Method of exact CCD.
     *
