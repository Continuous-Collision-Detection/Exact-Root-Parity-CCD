...
#include <CTCD.h> // Ettien Vouga's CCD using a root finder in floating points
#include <ECCD.hpp> // Teseo's reimplementation of Brochu et al. [2012] using rationals
#include <bsc.h> // Bernstein sign classification method of Tang et al. [2014]
#include <rootparitycollisiontest.h> // Root parity method of Brochu et al. [2012]
