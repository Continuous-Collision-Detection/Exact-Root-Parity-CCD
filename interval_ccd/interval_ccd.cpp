    ...
    double& toi)
{
    const auto distance = [&](const Eigen::VectorX3I& params) {
        ...
        Eigen::Vector2I vertex = (vertex_end - vertex_start) * t + vertex_start;

        // Get the vertex of the edge at time t
        Eigen::Vector2I edge_vertex0
            = (edge_vertex0_end - edge_vertex0_start) * t + edge_vertex0_start;
        Eigen::Vector2I edge_vertex1
            = (edge_vertex1_end - edge_vertex1_start) * t + edge_vertex1_start;
    ...
    Eigen::Vector2I toi_interval;
    bool is_impacting = interval_root_finder(
        distance, Eigen::Vector2I::Constant(Interval(0, 1)), tol, toi_interval);
    ...
    double& toi)
{
    const auto distance = [&](const Interval& t) {
        ...
        Eigen::Vector2I face_vertex0
            = (face_vertex0_end - face_vertex0_start) * t + face_vertex0_start;
        Eigen::Vector2I face_vertex1
            = (face_vertex1_end - face_vertex1_start) * t + face_vertex1_start;
        Eigen::Vector2I face_vertex2
            = (face_vertex2_end - face_vertex2_start) * t + face_vertex2_start;
    ...
    double& toi)
{
    const auto distance = [&](const Eigen::VectorX3I& params) {
        ...
        Eigen::Vector3I edge0_vertex0
            = (edge0_vertex0_end - edge0_vertex0_start) * t
            + edge0_vertex0_start;
        Eigen::Vector3I edge0_vertex1
            = (edge0_vertex1_end - edge0_vertex1_start) * t
            + edge0_vertex1_start;
        Eigen::Vector3I edge0_vertex
            = (edge0_vertex1 - edge_vertex0) * edge0_alpha + edge0_vertex0;

        Eigen::Vector3I edge1_vertex0
            = (edge1_vertex0_end - edge1_vertex0_start) * t
            + edge1_vertex0_start;
        Eigen::Vector3I edge1_vertex1
            = (edge1_vertex1_end - edge1_vertex1_start) * t
            + edge1_vertex1_start;
        Eigen::Vector3I edge1_vertex
            = (edge1_vertex1 - edge_vertex0) * edge1_alpha + edge1_vertex0;
    ...
    Eigen::Vector3d tol = compute_edge_edge_tolerance(
        ...
        edge1_vertex0_end, edge1_vertex1_end, face_vertex2_end);
