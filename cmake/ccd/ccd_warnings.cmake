...
if(TARGET ccd::warnings)
    return()
endif()

set(CCD_WARNING_FLAGS
    -Wall
    -Wextra
    -pedantic
...
add_library(ccd_warnings INTERFACE)
add_library(ccd::warnings ALIAS ccd_warnings)

foreach(FLAG IN ITEMS ${CCD_WARNING_FLAGS})
    ...
    if(IS_SUPPORTED_${FLAG_VAR})
        target_compile_options(ccd_warnings INTERFACE ${FLAG})
    endif()
endforeach()
